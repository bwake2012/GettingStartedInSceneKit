...
let view = SCNView(frame: CGRect(x: 0, y: 0, width: 1041, height: 630))
...
scene.background.contents = UIImage(named: "hubble_friday_04152016.jpg")
...
moonNode.position = SCNVector3(x: 0, y: 0, z: 4.0)
...
invisibleSphereNode.position = SCNVector3(x: 0, y:0, z: 0)
...
let rotateInvisible = SCNAction.rotateBy(x: 0, y: 1, z: 0.2, duration: 3)
